...
export default class Controller {
  public async list(req: Request, res: Response) {
    try {
      ...
      if (clientId != undefined)
        ...
        condition = { precious_metal_holder: req?.user?.client_id };
      ...
      return response.success('list data precious metal', preciousMetal, res);
    } catch (err: any) {
  ...
  public async detail(req: Request, res: Response) {
    try {
      ...
      return response.success('Data precious metal', preciousMetal, res);
    } catch (err: any) {
      return helper.catchError(
